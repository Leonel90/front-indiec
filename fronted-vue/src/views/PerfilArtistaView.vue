  ...
  <div class="content">
    <div class="header">
      <div id="capa-padre">
        ...
        <div id="app">
          <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
              ...
              <input type="text" id="nombre" v-model="formData.nombre" required placeholder="Nombre" />
            </div>
            <div class="form-group">
              <label for="apellido"></label>
              <input type="text" id="apellido" v-model="formData.apellido" required placeholder="Apellido" />
            </div>
            <div class="form-group">
              <label for="email"></label>
              <input type="email" id="email" v-model="formData.email" required placeholder="Correo " />
            </div>
            <div class="form-group">
              <label for="telefono1"></label>
              <input type="tel" id="telefono1" v-model="formData.telefono1" required placeholder="Celular " />
            </div>
          <div class="barra">
              <button  class="boton" type="button" @click="showModal = true">Editar</button>
          </div>
          </form>
        ...
        <input type="text" id="nombre" v-model="editData.nombre" required placeholder="Nombre" />
      </div>
      <div class="form-group2">
        <label for="apellido">Apellido:</label>
        <input type="text" id="apellido" v-model="editData.apellido" required placeholder="Apellido" />
      </div>
      <div class="form-group2">
        <label for="email">Correo :</label>
        <input type="email" id="email" v-model="editData.email" required placeholder="Correo " />
      </div>
      <div class="form-group2">
        <label for="telefono1"> Celular :</label>
        <input type="tel" id="telefono1" v-model="editData.telefono1" required placeholder="Celular " />
      </div>
